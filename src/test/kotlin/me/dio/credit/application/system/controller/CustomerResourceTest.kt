...
class CustomerResourceTest {
    ...
    @Autowired
    private lateinit var objectiveMapper: ObjectMapper
    ...
    fun `should create a customer and return 201 status`() {
        ...
        val valueAsString: String = objectiveMapper.writeValueAsString(customerDto)
        //when
        //then
        mockMvc.perform(
    ...
    fun `should update a customer and return 200 status`() {
        ...
        val valueAsString: String = objectiveMapper.writeValueAsString(customerUpdateDto)
        //when
        //then
        mockMvc.perform(
